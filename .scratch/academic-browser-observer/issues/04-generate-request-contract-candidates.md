...
- [x] Candidate generation correlates requests with the observation window using time, target, frame, initiator, redirects, schema, repetition, and provenance evidence.
...
- [x] Decoy requests with similar names or schemas do not outrank the request causally tied to the fixture operation.
