...
**Status:** automated-test verified (page/frame/popup topology core; live OOPIF/worker variants pending)

- [ ] Target inventory retains parent-child relationships for pages, frames, OOPIFs, popups, workers, and service workers using sanitized descriptors. (Page/frame/popup relationships are covered; worker ownership and live OOPIF behavior remain pending.)
