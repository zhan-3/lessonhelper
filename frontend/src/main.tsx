...
function App() {
  ...
  return <main className="shell">
    ...
    <section className="panel"><h2>主动检查官方选课通知</h2><p>仅解析批准的官方来源，不会执行选课操作。</p><input value={url} onChange={e => setUrl(e.target.value)} placeholder="https://jwc.hitwh.edu.cn/…" /><textarea value={text} onChange={e => setText(e.target.value)} placeholder="也可以粘贴通知正文" rows={4} /><button onClick={inspectNotice}>检查并生成候选</button></section>
